...
import com.JAVA并发编程的艺术.notifyTest.Test;
...
//        test2();
    ...
    public static void test1(){
        ...
        try{
            fis=new FileInputStream("D:\\task\\java\\interviewStudy\\src\\com\\JAVA_NIO\\1.jpg");
            ...
            while(inChannel.read(buf)!=-1){
                buf.flip();//切换读取数据的模式
                //4.将缓冲区中的数据写入通道中 从通道中读数据到缓冲区，把缓冲区中的数据写到通道
    ...
    public static void  test2() {
        ...
        FileChannel outChannel=null;
        try {
            inChannel = FileChannel.open(Paths.get("./src/com/JAVA_NIO/1.jpg"), StandardOpenOption.READ);
            outChannel=FileChannel.open(Paths.get("./src/com/JAVA_NIO/3.jpg"), StandardOpenOption.WRITE,StandardOpenOption.READ,StandardOpenOption.CREATE);

            //内存映射文件 只有MappedByteBuffer一种，别的数据格式不支持
